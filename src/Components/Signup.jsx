        ...
        <div className="row  mt-3 justify-content-center" >
            <div className='col-md-6  card  shadow bg-dark'>
                ...
                <form action="" onSubmit={handlesubmit}>
                    ...
                    <input type="password" placeholder='🔐Enter password' className='form-control rancho-regular' onChange={(e) => setPassword(e.target.value)} /><br /><br />
                    <input type="phone" placeholder='📞Enter phone' className='form-control rancho-regular' onChange={(e) => setPhone(e.target.value)} /><br />

                    <button type=' Submit' className='btn btn-danger text-white w-100  oi-regular'>Sign up</button>
